...
public class DateGuidePickerDialog extends Dialog {

    private static int MIN_YEAR = 2016;
    private static int MAX_YEAR = 2037;
    private Params params;


    public DateGuidePickerDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    private void setParams(DateGuidePickerDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final DateGuidePickerDialog.Params params;
        ...
        public Builder(Context context) {
            ...
            params = new DateGuidePickerDialog.Params();
        }
        ...
        public DateGuidePickerDialog create() {
            final DateGuidePickerDialog dialog = new DateGuidePickerDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            View view = LayoutInflater.from(context).inflate(R.layout.layout_picker_date_guide, null);
            ...
            if (selectYear != null) {
                if (d(MIN_YEAR, MAX_YEAR - MIN_YEAR + 1).contains(selectYear)) {
